old_cachama = [
    ...
    "El Profe Angel dijo que {name} deje el spam, que con {total} cachamas tiene suficiente"
    ]
...
new_cachama = [
    ...
    "Robottacha le entrego a {name}, {new} cachamas, y que cuide ahora sus {total} cachamas"
    ]
